...
SyntaxHighlighter.brushes.Tcl = function()
{
	 ...
	 */
	var keywords = 'proc if then return while for set unset break continue foreach package namespace catch upvar global try catch tailcall coroutine yield yieldto';
